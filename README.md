...
|2|マイページ機能|マイページにおいて自身が登録した住所や購入履歴を確認できる様にするため|登録した情報をマイページで確認できる|ヘッダー部分のユーザー名をクリックするとマイページに遷移できる|2時間|
|2|サイドバーの商品一覧機能|商品別に商品を閲覧できる様に実装|ユーザーが商品を探しやすい様にサイドバーを付けそこから商品の一覧ができる様に実装|サイドバーをクリックすると商品一覧ページへ遷移する|2時間|
...
各商品一覧機能![2aea42ca7192f8d00fc404a2632494e8](https://user-images.githubusercontent.com/71533935/100703243-76967a80-33e6-11eb-8960-65fde0623e23.jpg)
